...
const EditProduct = ({ existingProduct, onSave }) => {
  ...
  useEffect(() => {
    ...
    setProduct({
      ...
      description: existingProduct.description
        ? JSON.parse(existingProduct.description)
        : { blocks: [] },
      ...
      taxStatus: mapIdsToOptions(
        existingProduct.tax_status_id || [],
        taxOption
      ),
      shipping: mapIdsToOptions(
        existingProduct.shipping_id || [],
        shippingOption
      ),
  ...
  const handleSubmit = async (e) => {
    ...
    const editorData = (await editorRef.current?.save()) || product.description;
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <form
        ...
        className="mt-4 w-full flex md:flex-row flex-col gap-4"
      >
        {/* LEFT */}
        <div className="md:w-3/4 w-full border border-gray-300 p-4 rounded-lg flex flex-col gap-4">
          ...
          <div>
            ...
            <Editor
              ref={editorRef}
              holderId="edit-product-description-editor"
              data={product.description}
            />
          </div>
          <div className="flex flex-col border rounded-md">
            <h3 className="text-sm pl-2 py-2 border-b font-semibold">
              Product Data
            </h3>
            <div className="flex">
            ...
            <div className="grid grid-cols-3 gap-4 mb-4">
              {existingImages.map((img, i) => (
                <div key={i} className="relative group">
                  <img
                    src={
                      `${import.meta.env.VITE_API_BASE_URL}storage/${img}` ||
                      img
                    }
                    alt=""
